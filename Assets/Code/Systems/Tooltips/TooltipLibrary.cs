    ...
    public static void FetchInfo(string target, out string header, out string body)
    {
        ...
        switch (target)
        {
            ...
            case "Register File":
                ...
                body = "A register is a storage unit within a CPU" +
                    " that can hold data temporarily.The register" +
            ...
            case "Mux":
                ...
                body = "Digital switch that selects one input from" +
                    " multiple inputs and outputs it can perform" +
                    " complex operations by selecting the" +
                    " appropriate input signal for each operation" +
                    " based on a control signal.";
                break;
            case "Fetch":
                header = "Instruction Fetch";
                body = "The first stage of the pipeline fetches" +
                    " the next instruction from memory and" +
                    " prepares it for execution.";
                break;
            case "Decode":
                header = "Instruction Decode";
                body = "The second stage decodes the instruction" +
                    " and determines what operation needs to be" +
                    " performed.";
                break;
            case "Execute":
                header = "Execute";
                body = "The processor performs the necessary" +
                    " operation on the data, such as addition or" +
                    " multiplication.";
                break;
            case "Memory Access":
                header = "Memory Access";
                body = "If the instruction requires accessing" +
